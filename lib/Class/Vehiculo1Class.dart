...
class Vehiculo1 extends StatefulWidget {
 
  @override
  _Vehiculo1State createState() => _Vehiculo1State();
}

class _Vehiculo1State extends State<Vehiculo1> {
...
//************************************************************** */
  ...
  void initState() {
    ...
    _cargarPref()async{
      ...
      setState(() {
        celular1 = prefs.getString("celular1");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: new ThemeData(scaffoldBackgroundColor: const Color(0xFF4A148C)),
      ...
      floatingActionButton: FloatingActionButton(onPressed: ()async{//Boton Guardar
        ...
        setState(() {
          celular1 = tel.text;
          prefs.setString("celular1", tel.text);
        });
      },
