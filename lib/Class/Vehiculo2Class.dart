...
class Vehiculo2 extends StatefulWidget {
 
  @override
  _Vehiculo2State createState() => _Vehiculo2State();
}

class _Vehiculo2State extends State<Vehiculo2> {
...
//************************************************************** */
  ...
  void initState() {
    ...
    _cargarPref()async{
      ...
      setState(() {
        celular1 = prefs.getString("celular2");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: new ThemeData(scaffoldBackgroundColor: const Color(0xFF1B5E20)),
      ...
      floatingActionButton: FloatingActionButton(onPressed: ()async{//Boton Guardar
        ...
        setState(() {
          celular1 = tel.text;
          prefs.setString("celular2", tel.text);
        });
      },
