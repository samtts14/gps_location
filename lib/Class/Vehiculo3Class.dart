...
class Vehiculo3 extends StatefulWidget {
 
  @override
  _Vehiculo3State createState() => _Vehiculo3State();
}

class _Vehiculo3State extends State<Vehiculo3> {
...
//************************************************************** */
  ...
  void initState() {
    ...
    _cargarPref()async{
      ...
      setState(() {
        celular1 = prefs.getString("celular3");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      floatingActionButton: FloatingActionButton(onPressed: ()async{//Boton Guardar
        ...
        setState(() {
          celular1 = tel.text;
          prefs.setString("celular3", tel.text);
        });
      },
